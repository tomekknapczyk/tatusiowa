...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios('/index.json').then(function (response) {
      _this2.fuse = new fusejs(response.data, {
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "absolute md:relative w-full justify-end items-center flex bg-white h-full md:h-auto md:bg-transparent left-0 top-0 z-10 mt-7 md:mt-0 px-4 md:px-0",
          class: { "hidden md:flex bg-transparent": !_vm.searching }
        },
        [
          ...
          _c("input", {
            ...
            ref: "search",
            staticClass:
              "transition-fast relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 bg-grey-lightest border border-grey focus:border-blue-light outline-none cursor-pointer text-grey-darker px-4 pb-0",
          ...
          _vm.query || _vm.searching
            ? _c(
                ...
                {
                  staticClass:
                    "absolute top-0 right-0 h-10 font-light text-3xl text-blue hover:text-blue-dark focus:outline-none -mt-px pr-7 md:pr-3"
                },
                [_vm._v("×")]
              )
            : _vm._e(),
          ...
          _c("transition", { attrs: { name: "fade" } }, [
            _vm.query
              ? _c(
                  ...
                  {
                    staticClass:
                      "absolute top-0 right-0 mt-16 w-full lg:w-3/4 text-left mb-4 md:mt-10 max-h-screen md:max-h-500 overflow-auto"
                  },
                  [
                    _c(
                      "div",
                      {
                        staticClass:
                          "flex flex-wrap items-start justify-start bg-white border border-b-0 border-t-0 border-blue-light rounded-b-lg shadow-lg mx-4 md:mx-0"
                      },
                      [
                        _vm._l(_vm.results, function(result, index) {
                          return _c(
                            "a",
                            {
                              ...
                              staticClass:
                                "bg-white hover:bg-blue-lightest border-b border-blue-light text-xl cursor-pointer p-4 w-full",
                              class: {
                            ...
                            [
                              ...
                              _c("span", {
                                staticClass:
                                  "block font-normal text-grey-darker text-sm my-1",
                                domProps: {
                        ...
                        !_vm.results.length
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "bg-white w-full hover:bg-blue-lightest border-b border-blue-light rounded-b-lg shadow cursor-pointer p-4"
                              },
                              [
      ...
      _c(
        ...
        {
          staticClass:
            "flex md:hidden bg-grey-lightest hover:bg-blue-lightest justify-center items-center border border-grey rounded-full focus:outline-none h-10 px-3",
...
window.fusejs = fuse_js__WEBPACK_IMPORTED_MODULE_0__["default"];
...
window.onload = function () {
  ...
  baguettebox_js__WEBPACK_IMPORTED_MODULE_4___default.a.run('.post-content');
};
...
__webpack_require__(/*! /Users/tomekknapczyk/code/tatusiowa/source/_assets/js/main.js */"./source/_assets/js/main.js");
module.exports = __webpack_require__(/*! /Users/tomekknapczyk/code/tatusiowa/source/_assets/sass/main.scss */"./source/_assets/sass/main.scss");
